...
public class FormatAListObject {
    ...
    private static final String TAG = FormatAListObject.class.getName();

    public void formatAListObject() {
        try {
            ...
            workbook.save(filePath + File.separator + "FormatAListObject_Out.xlsx");
        } catch (Exception e) {
            Log.e(TAG, "Format a List Object", e);
        }
    }
}
