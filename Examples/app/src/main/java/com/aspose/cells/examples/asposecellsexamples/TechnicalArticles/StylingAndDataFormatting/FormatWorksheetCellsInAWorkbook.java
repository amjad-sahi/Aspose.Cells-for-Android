...
public class FormatWorksheetCellsInAWorkbook {

    private static final String TAG = FormatWorksheetCellsInAWorkbook.class.getName();

    public void formatWorksheetCellsInAWorkbook() {
        try {
            ...
            workbook.save(filePath + "FormatWorksheetCells_Out.xlsx", SaveFormat.XLSX);
        } catch (Exception e) {
            Log.e(TAG, "Format Worksheet Cells in a Workbook", e);
        }
    }
}
