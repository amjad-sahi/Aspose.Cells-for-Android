...
public class RestrictionsOfExcel2003WhileRefreshingPivotTable {

    private static final String TAG = RestrictionsOfExcel2003WhileRefreshingPivotTable.class.getName();

    /**
     * Aspose.Cells provides the PivotTable.IsExcel2003Compatible property which you can use to specify whether the Pivot Table
     * is compatible for Excel 2003 for refreshing purposes. If true, a string must be less than or equal to 255 characters,
     * so if the string is greater than 255 characters, it will be truncated.
     * If false, a string will not have the aforementioned restriction.
     * The default value is true.
     */
    public void restrictionsOfExcel2003WhileRefreshingPivotTable() {
        try {
            String root = Environment.getExternalStorageDirectory().toString();
            File myDir = new File(root + File.separator + "Aspose");
            String filePath = myDir.getCanonicalPath() + File.separator;

            //Load source spreadsheet containing a pivot table
            Workbook book = new Workbook(filePath + "sample-pivot-table.xlsx");
            ...
            String longStr = "Very long text 1. very long text 2. " +
                                "very long text 3. very long text 4. very long text 5. " +
                                "very long text 6. very long text 7. very long text 8. " +
                                "very long text 9. very long text 10. very long text 11. " +
                                "very long text 12. very long text 13. very long text 14. " +
                                "very long text 15. " +
                                "very long text 16. very long text 17. " +
                                "very long text 18. very long text 19. " +
                                "very long text 20. End of text.";
            cell = cells.get("B3");
            ...
            Worksheet pivotSheet = book.getWorksheets().get(1);
            ...
            Log.i(TAG, "Length of cell B5 after setting IsExcel2003Compatible property to True: " + b5.getStringValue().length());
            ...
            Log.i(TAG, "Length of cell B5 after setting IsExcel2003Compatible property to False: " + b5.getStringValue().length());
            ...
            book.save(filePath + "RestrictionsOfExcel2003_Out.xlsx", SaveFormat.XLSX);
        } catch (Exception e) {
            Log.e(TAG, "Restrictions of Excel 2003 while Refreshing Pivot Table", e);
        }
    }
}
